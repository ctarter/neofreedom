...
action kdb,backtrace
	...
	*/
	Public Static Function classes() {
		...
		?>
<div class="krumo-title">
action kdb,classes - This is a list of all currently declared classes.
</div>
		<?php
	...
	*/
	Public Static Function interfaces() {
		...
		?>
<div class="krumo-title">
action kdb,interfaces - all declared interfaces.
</div>
		<?php
	...
	*/
	Public Static Function includes() {
		...
		?>
<div class="krumo-title">
action kdb,includes - all included (or required) files.
</div>
		<?php
	...
	*/
	Public Static Function functions() {
		...
		?>
<div class="krumo-title">
action kdb,functions - all declared functions.
</div>
		<?php
	...
	*/
	Public Static Function defines() {
		...
		?>
<div class="krumo-title">
action kdb,defines - all declared constants (defines).
</div>
		<?php
	...
	*/
	Public Static Function extensions() {
		...
		?>
<div class="krumo-title">
action kdb,extensions - extensions all currently loaded PHP extensions.
</div>
		<?php
	...
	*/
	Public Static Function headers() {
		...
		?>
<div class="krumo-title">
action kdb,headers - HTTP request headers.
</div>
		<?php
	...
	*/
	Public Static Function phpini() {
		...
		?>
<div class="krumo-title">
action kdb,phpini - PHP.INI read from <code><b><?php echo get_cfg_var('cfg_file_path');?></b></code>.
</div>
		<?php
	...
	*/
	Public Static Function conf() {
		...
		?>
<div class="krumo-title">
action kdb,conf - configuration settings.
</div>
		<?php
	...
	*/
	Public Static Function path() {
		...
		?>
<div class="krumo-title">
action kdb,path - directories in your <code><b>include_path</b></code> option.
</div>
		<?php
	...
	*/
	Public Static Function request() {
		...
		?>
<div class="krumo-title">
action kdb,request <code><b>$_REQUEST</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function get() {
		...
		?>
<div class="krumo-title">
action kdb,get <code><b>$_GET</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function post() {
		...
		?>
<div class="krumo-title">
action kdb,post <code><b>$_POST</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function server() {
		...
		?>
<div class="krumo-title">
action kdb,server <code><b>$_SERVER</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function cookie() {
		...
		?>
<div class="krumo-title">
action kdb,cookie <code><b>$_COOKIE</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function env() {
		...
		?>
<div class="krumo-title">
action kdb,env <code><b>$_ENV</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function session() {
		...
		?>
<div class="krumo-title">
action kdb,session <code><b>$_SESSION</b></code> array.
</div>
		<?php
	...
	*/
	Public Static Function ini($ini_file) {
		...
		?>
<div class="krumo-title">
action kdb,ini <code><b><?php echo realpath($ini_file) ? realpath($ini_file) : $ini_file;?></b></code> INI file.
</div>
		<?php
		return krumo::dump($_);
		}
    ...
    Public Static Function kdbMsg($msg)
    {
        self::$kdbMsg=$msg;
    }
    public static $kdbMsg='';
    public static $kdbCaller='';
	/**
...
<div class="krumo-root"> <?
        if (!self::$kdbCaller) {
            $d=array_pop($_);
            if (!empty($d['function'])) self::$kdbCaller='function: '.$d['function'];
            elseif (!empty($d['method'])) self::$kdbCaller='method: '.$d['method'];
            else self::$kdbCaller=var_export($d,true);

        }
        if (@self::$kdbCaller) { $call=self::$kdbCaller;
        ?>
        <span class="krumo-call" style="white-space:nowrap;">
            Called from <?=$call?></span>
        <?php } ?>
	<ul class="krumo-node krumo-first">
		<?php echo krumo::_dump($data);?>
		<li class="krumo-footnote">
			<div class="krumo-version" style="white-space:nowrap;">
				<h6><?php echo (empty(self::$kdbMsg) ? "Krumo-Call" : self::$kdbMsg); self::$kdbMsg=null;?></h6>
			</div>
		&nbsp;
		</li>
	</ul>
...
<div class="krumo-title">
action kdb,disable - screen dumps enabled (at <?=krumo::$kdbCaller?>)
</div> <?
...
<div class="krumo-title">
action kdb,disable - screen dumps disabled (at <?=krumo::$kdbCaller?>)
</div><?
...
/**
* interface with krumo
*
* @param mixed $args - either array('data' => $data, ['msg' => $msg]) OR 'krumomethod' OR $data
*/
