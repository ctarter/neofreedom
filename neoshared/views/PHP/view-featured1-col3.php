<?php
/**
* view-featured1-col3.tpl parsed at 10/29/09 4:10.32 am
...
echo $this->get('view-top','');
 
## $POSTS Begin loop 
$this->set('COUNTER',1);
$POSTS = $this->get('POSTS',array());
foreach($POSTS as $live_rec) { 
...
echo $this->getElem('live-rec','author'); 
 } ?>
        </div>

        <div class="<?=$this->get('content-block','');?>">
            <?=$this->getElem('live-rec','thumbnail'); 
echo $this->getElem('live-rec','post_content'); ?>
        </div>
<? } 
 ...
 $this->set('i','4'); 
        ...
        <div class="threepost threepost<?=$this->get('i','');?>">
            ...
            <div class="meta">
                ...
                <div class="date"><?=$this->getElem('live-rec','post_modified'); 
echo $this->getElem('live-rec','post_author'); ?></div>
                <? } ?>
            </div>

            <div class="<?=$this->get('content-block','');?>">
                <?=$this->getElem('live-rec','post_excerpt'); 
echo $this->getElem('live-rec','more-link'); ?>
            </div>
         </div>
