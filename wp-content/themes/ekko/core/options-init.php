          ...
          $this->sections[] = array(
              ...
              'fields' => array(
                ...
                array(
                    ...
                    'subtitle' => esc_html__('Choose logo width on mobile. Pixels value.', 'ekko'),
                    'required' => array('tek-logo-style','equals','1'),
                ),
                array(
                    'id' => 'tek-text-logo',
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'section',
                        'title' => esc_html__('Header Icons', 'ekko'),
                        'indent' => true,
                    ),
                    array(
                        ...
                        'subtitle' => esc_html__('Turn on to display search icon', 'ekko'),
                    ...
                    array(
                        ...
                        'subtitle' => esc_html__('Turn on to display cart icon.', 'ekko'),
                    ...
                    array(
                        ...
                        'subtitle' => esc_html__('Turn on to display the language switcher.', 'ekko'),
              ...
              $this->sections[] = array(
                  ...
                  'fields' => array(
                    ...
                    array(
                        ...
                        'subtitle' => esc_html__('Turn on to display topbar on mobile devices.', 'ekko'),
                        'default' => false
                    ),
                        array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'subtitle' => esc_html__('Activate to display upper footer. Contains footer widget areas.', 'ekko'),
                        'default' => true
                    ),
                    array(
            ...
            $this->sections[] = array(
                'title' => esc_html__('Responsive Typography', 'ekko'),
                'subsection' => true,
                'fields' => array(
                array(
              ...
              $this->sections[] = array(
                  ...
                  'fields' => array(
                      ...
                      array(
                          ...
                          'subtitle' => esc_html__('Note: Sidebar is visible only on 2 columns layout', 'ekko'),
                          'select2' => array('allowClear' => false, 'minimumResultsForSearch' => '-1'),
                          'options'  => array(
                              'woo-2-columns' => '2 Columns + Sidebar',
                              'woo-3-columns' => '3 Columns ( No Sidebar )',
                              'woo-4-columns' => '4 Columns ( No Sidebar )',
                          ),
              ...
              $this->sections[] = array(
                  ...
                  'fields' => array(
                    array(
                        ...
                        'subtitle' => esc_html__('Enable/Disable title & breadcrums area on single product page.', 'ekko'),
                        'default' => '1',
                        '1' => 'Yes',
                        '0' => 'No',
                    ),
