...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});var wpAjaxUrl='https://staging.neoxenos.org/wp-admin/admin-ajax.php';var flBuilderUrl='https://staging.neoxenos.org/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://staging.neoxenos.org/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://staging.neoxenos.org/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
