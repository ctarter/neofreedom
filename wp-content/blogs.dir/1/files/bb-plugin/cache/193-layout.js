...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});var wpAjaxUrl='https://neoxenos.org/wp-admin/admin-ajax.php';var flBuilderUrl='https://neoxenos.org/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://neoxenos.org/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://neoxenos.org/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
if(jQuery('body').hasClass('fl-builder-edit')&&this.small_device<30){jQuery('body').find(node).addClass('uabb-mobile-spacer-height-adjustment');}},};})(jQuery);jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c681cbf36d',desktop_space:'110',medium_device:'50',small_device:'50',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c681cbf378',desktop_space:'110',medium_device:'50',small_device:'50',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5d092e3c81add',desktop_space:'',medium_device:'',small_device:'',});});jQuery(function($){$(function(){$('.fl-node-5d092e215696c .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c4e265284b1c',desktop_space:'',medium_device:'500',small_device:'500',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c73bc5d8e5',desktop_space:'60',medium_device:'20',small_device:'20',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c73bc5d8e4',desktop_space:'60',medium_device:'20',small_device:'20',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c4e2799d569c',desktop_space:'',medium_device:'500',small_device:'500',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c788fb6f79',desktop_space:'60',medium_device:'20',small_device:'20',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c788fb6f76',desktop_space:'60',medium_device:'20',small_device:'20',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5d092f8d7cdde',desktop_space:'',medium_device:'',small_device:'',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c4e29c48ca12',desktop_space:'',medium_device:'',small_device:'',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c7bd5be164',desktop_space:'60',medium_device:'20',small_device:'20',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c3c7bd5be167',desktop_space:'60',medium_device:'20',small_device:'20',});});;(function($){var form=$('.fl-builder-settings'),gradient_type=form.find('input[name=uabb_row_gradient_type]');$(document).on('change','input[name=uabb_row_radial_advance_options], input[name=uabb_row_linear_advance_options], input[name=uabb_row_gradient_type], select[name=bg_type]',function(){var form=$('.fl-builder-settings'),background_type=form.find('select[name=bg_type]').val(),linear_direction=form.find('select[name=uabb_row_uabb_direction]').val(),linear_advance_option=form.find('input[name=uabb_row_linear_advance_options]:checked').val(),radial_advance_option=form.find('input[name=uabb_row_radial_advance_options]:checked').val(),gradient_type=form.find('input[name=uabb_row_gradient_type]:checked').val();if(background_type=='uabb_gradient'){if(gradient_type=='radial'){setTimeout(function(){form.find('#fl-field-uabb_row_linear_direction').hide();form.find('#fl-field-uabb_row_linear_gradient_primary_loc').hide();form.find('#fl-field-uabb_row_linear_gradient_secondary_loc').hide();},1);if(radial_advance_option=='yes'){form.find('#fl-field-uabb_row_radial_gradient_primary_loc').show();form.find('#fl-field-uabb_row_radial_gradient_secondary_loc').show();}}
