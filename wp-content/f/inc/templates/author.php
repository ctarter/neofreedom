		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				<header class="page-header author-header">
					...
					<h1><?php echo esc_html__( 'About:', 'casttools' ) . ' ' . esc_html( $curauth->nickname ); ?></h1>
					...
					<?php if ( ! empty( $curauth->user_url ) || ! empty( $curauth->user_description ) ) : ?>
						<dl>
							<?php if ( ! empty( $curauth->user_url ) ) : ?>
								<dt><?php esc_html_e( 'Website', 'casttools' ); ?></dt>
								<dd>
							...
							<?php if ( ! empty( $curauth->user_description ) ) : ?>
								<dt><?php esc_html_e( 'Profile', 'casttools' ); ?></dt>
								<dd><?php esc_html_e( $curauth->user_description ); ?></dd>
							<?php endif; ?>
						</dl>
					<?php endif; ?>

					<h2><?php echo esc_html( 'Posts by', 'casttools' ) . ' ' . esc_html( $curauth->nickname ); ?>:</h2>
						...
						<?php while ( have_posts() ) : the_post(); ?>
							<li>
								...
								printf(
									...
									esc_attr( __( 'Permanent Link:', 'casttools' ) ),
									the_title( '', '', false )
								);
								?>
								<?php casttools_posted_on(); ?>
								<?php esc_html_e( 'in', 'casttools' ); ?>
								<?php the_category( '&' ); ?>
							</li>
						<?php endwhile; ?>
