...
<fieldset class="bbp-form gdpol-topic-poll-form">
    ...
    <div id="gdpol-poll-status" class="gdpol-field gdpol-field-checkbox">
        <label>
            <input<?php echo $_poll->status == 'enable' ? ' checked="checked"' : ''; ?> class="gdpol-poll-status" type="checkbox" name="gdpol[poll][status]" value="enable" /> <span><?php _e("Add poll to this topic", "gd-topic-polls"); ?></span>
        </label>
    </div>
