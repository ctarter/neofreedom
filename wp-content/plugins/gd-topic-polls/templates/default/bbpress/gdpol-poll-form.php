...
<div class="gdpol-fields-wrapper" style="display: <?php echo $_poll->status == 'enable' ? 'block' : 'none'; ?>;">
    ...
    <div class="gdpol-field gdpol-field-responses">
        ...
        <p class="gdpol-description">
            <?php _e("Removing responses will invalidate votes assigned to removed responses. Chnaging the responses order is not affecting saved votes.", "gd-topic-polls"); ?>
        </p>
    ...
    <div class="gdpol-field gdpol-field-regular">
        <label>
            ...
            <?php gdpol_render_dropdown($_poll->form_data('show'), array(
                      'selected' => $_poll->show, 
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            gdpol_plugin_edit.run(<?php echo $i; ?>, <?php echo $m; ?>);
        });
    </script>
