...
$_classes = array('d4p-wrap', 'wpv-'.GDPOL_WPV, 'd4p-page-update');
    ...
    <div class="d4p-content">
        <div class="d4p-content-left">
            <div class="d4p-panel-title">
                ...
                <h3><?php _e("Update", "gd-topic-polls"); ?></h3>
            </div>
            <div class="d4p-panel-info">
                <?php _e("Before you continue, make sure plugin was successfully updated.", "gd-topic-polls"); ?>
            </div>
        </div>
