...
<div class="kdadmin-dashboard wrap">
	...
	<div class="kdadmin-req-wrapper">
				...
				<!-- <h3><?php esc_html_e( 'WordPress environment', 'keydesign' ) ?></h3> -->
				<div class="sys-row theme-version">
					...
					<div class="sys-current">
						<?php
							if ( wp_get_theme( 'ekko' )->exists() && defined('EKKO_THEME_VERSION') ) {
								echo EKKO_THEME_VERSION;
							} else {
								echo '<span class="sys-error"><span class="dashicons dashicons-warning"></span>' . esc_html__( 'You are using an outdated theme version. Please update it.', 'keydesign' ) .'</span>';
							}
						?>
					</div>
				</div>
